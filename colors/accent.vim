...
let s:accent = get(g:, 'accent_colour', 'insi')
...
" background
let s:bg      = ' guibg=#181818 ctermbg=236'
let s:bg_b1   = ' guibg=#181818 ctermbg=237'
let s:bg_b2   = ' guibg=#101010 ctermbg=238'
...
if s:darken
  ...
  let s:bg      = ' guibg=#101010 ctermbg=234'
endif
...
"
"" diff
"let s:diff_red    = ' guifg=#e06c75 guibg=#101010 gui=NONE ctermfg=167 ctermbg=NONE'
...
"
"execute 'hi DiffAdd'    . s:diff_red
"execute 'hi DiffDelete' . s:diff_green
